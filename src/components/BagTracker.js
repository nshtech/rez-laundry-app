...
export class BagTracker extends Component {
    ...
    updateWeightStatus(props,value, date) {
        if (firebase.database().ref('/customers/' + props.rowData.id + '/'+'weekweight'+'/'+date) > props.rowData.maxweight) {
    ...
    async onEditorValueChange(props, value) {
        ...
        // var stringdate = curryear + '-' + currmonth + '-' + currday;
        // var currdate = new Date(stringdate);
        // console.log('test date: ');
        // console.log(testDate);
        //testing date dictionary: 
        //firebase.database().ref('/customers/' + props.rowData.id + '/' + 'weekweight' + '/'+ stringdate).set(value)
        firebase.database().ref('/customers/' + props.rowData.id + '/' + props.field).set(value)
        let updatedCars = [...props.value];
        updatedCars[props.rowIndex][props.field] = value;
        this.setState({ customers: updatedCars });

        const curr = await this.updateWeightStatus(props,value, stringdate);
